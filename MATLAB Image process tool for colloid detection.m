...
scaling_factor = 2000 / 1008;  % nanometers per pixel %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
greenThresholdMin = 180;   % Green for 180~220 nm
greenThresholdMax = 220;   % Upper limit for Green
blueThreshold = 180;   % Blue for < 180 nm
